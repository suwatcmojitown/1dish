...
class Category extends MY_Controller {
	...
	public function manageContent()
	{
		...
		$selectList = $this->Category_model->getSelectContentList();
		if($selectList)
		{
		...
		$this->template['content'] = $this->load->view ($this->middle = 'category/manageContent',$data, true);
		$this->master_layout();
	...
	public function reorder()
	{
		...
		$list = $this->Category_model->getSelectContentList();
		if($list)
		{
			$data['list'] = $list->body;
		}
		...
		$this->template['menu'] = $this->load->view ($this->menu = 'layouts/menu');
		$this->template['content'] = $this->load->view ($this->middle = 'category/reorder',$data, true);
		$this->master_layout();
		//$this->load->view ('shelf/manageContent',$data);
	...
	public function deleteContentItem()
	{
		...
		$temp->id = $_POST['id'];
		$result = $this->Category_model->delete($temp);
		...
		$this->load->view('category/loadSelectList',$data);
	...
	public function edit()
	{
		...
		$id = $_POST['id'];
		$detail = $this->Category_model->getContentDetail($id);
		$data['detail'] = $detail;
		
		if($detail)
		{
			$this->load->view('category/editContent',$data);
		}
	}
	...
	public function updateOrder(){
		...
		*/
		...
		$result = $this->Category_model->updateOrder($sortList);
		echo $result;
		//console($sortList);
		/*
