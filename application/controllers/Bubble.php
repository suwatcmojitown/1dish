...
class Bubble extends MY_Controller {
	...
	public function manageContent()
	{
		...
		$this->template['content'] = $this->load->view ($this->middle = 'bubble/manageContent',$data, true);
		$this->master_layout();
	...
	public function deleteContentItem()
	{
		...
		$temp->id = $_POST['id'];
		$result = $this->Bubble_model->delete($temp);
		...
		$this->load->view('bubble/loadSelectList',$data);
	...
	public function addContent(){
		...
		//console($data);
		$result = $this->Bubble_model->add($data);
		echo $result;
	...
	{
		$id = $_POST['id'];
		$detail = $this->Bubble_model->getContentDetail($id);
		$data['detail'] = $detail;
		
		if($detail)
		{
			$this->load->view('bubble/editContent',$data);
		}
	}
	...
	public function updateContent(){
		...
		$data->external_link = $_POST['external_link'];
		//console($data);
		$result = $this->Bubble_model->update($data);
		//console($result);
		echo $result;
	}
