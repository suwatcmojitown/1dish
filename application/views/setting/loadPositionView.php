<form id="positionForm">                                
                                                                <label>Name : </label>
                                                                <div class="mb-1">
                                                                    <input type="text" value="<?php echo @$detail->name;?>" class="form-control" name="title">
                                                                    <input type="hidden" value="<?php echo @$detail->position_id;?>" class="form-control" name="position_id">
                                                                </div>
