<table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a onclick="getOccupationDetail(<?php echo $row->occupation_id;?>)" data-toggle="modal"><button type="button" class="btn btn-icon rounded-circle btn-outline-primary waves-effect" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="แก้ไข" data-bs-target="#warning-1">
