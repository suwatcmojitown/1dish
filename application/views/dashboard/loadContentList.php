<div class="col-xl-3 col-xxl-3 col-lg-6 col-md-6 col-sm-6">
              ...
              <div class="card-body p-4">
                <div class="media ai-icon d-flex">  
                  ...
                  <div class="media-body" style="padding-left: 4px;">
                    ...
                    <p class="mb-0"><h4 style="font-family: 'kanit';">ยอดรวม</h4></p>
              ...
              <div class="card-body p-4">
                <div class="media ai-icon d-flex">
                  ...
                  <div class="media-body" style="padding-left: 4px;">
                    ...
                    <p class="mb-0"><h4 style="font-family: 'kanit';">ค่าจอด</h4></p>
              ...
              <div class="card-body p-4">
                <div class="media ai-icon d-flex">
                  ...
                  <div class="media-body" style="padding-left: 4px;">
                    ...
                    <p class="mb-0"><h4 style="font-family: 'kanit';">คอมไกด์</h4></p>
              ...
              <div class="card-body p-4">
                <div class="media ai-icon d-flex">
                  ...
                  <div class="media-body" style="padding-left: 4px;">
                    ...
                    <p class="mb-0"><h4 style="font-family: 'kanit';">คอมทัวร์</h4></p>
          ...
          <div class="col-xl-8 col-xxl-8 col-lg-12 col-md-12">
            <div class="card">
              <div class="card-header border-0 pb-0 d-sm-flex flex-wrap d-block" style="background-color: rgba(47,76,221,0.1);">
                <div class="mb-3">
                  <h4 class="card-title mb-1 text-primary" style="font-weight: 600;font-size: 21px!important;font-family: 'Kanit';">สรุปยอดขายประจำวัน</h4>
                </div>
          ...
          <div class="col-xl-4 col-xxl-4 col-lg-12 col-md-12">
            ...
            <div class="card overflow-hidden">
              <div class="social-graph-wrapper widget-linkedin" style="background-color: rgba(47,76,221,0.1)!important;">
                <span class="s-icon text-primary" style="font-weight: 600;font-size: 21px!important;font-family: 'Kanit';">ค่าจอด</span>
              </div>
              <div class="row">
                <div class="col-6 border-end">
                  <div class="pt-3 pb-3 ps-0 pe-0 text-center">
                    <h2 class="fs-23 font-w600 counter"><?php echo number_format(@$parkingSummaryList->total_parking);?></h2>
                    
                    <p class="fs-16 mb-0" style="font-weight: 600;font-size: 21px!important;font-family: 'Kanit';">บาท</p>
                  </div>
                </div>
                <div class="col-6">
                  <div class="pt-3 pb-3 ps-0 pe-0 text-center">
                    <h2 class="fs-23 font-w600 counter"><?php echo number_format(@$parkingSummaryList->total_group);?></h2>
                    <p class="fs-16 mb-0" style="font-weight: 600;font-size: 21px!important;font-family: 'Kanit';">กลุ่ม</p>
                  </div>
                </div>
              </div>
            </div>
