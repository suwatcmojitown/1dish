      ...
      <div class="container-fluid">
        <div class="form-head d-flex mb-3 align-items-start">
          <div class="me-auto d-none d-lg-block">
            <h2 class="text-primary font-w600 mb-0" >Dashboard : <?php echo $show_date;?></h2>
            ...
            <div class="widget-stat card">
              <div class="card-body p-4">
                <div class="media ai-icon d-flex">  
                  <span class="me-1 bgl-primary text-primary">
                    <!-- <i class="ti-user"></i> -->
                  ...
                  <div class="media-body" style="padding-left: 4px;">
                    <h3 class="mb-2 text-black" style="font-size:1.8rem;font-weight: 600;"><span class="counter ms-0"><?php echo number_format(@$incomeSummaryList->grand_total);?></span></h3>
                    <p class="mb-0"><h5 style="font-family: 'kanit';">ยอดรวม</h5></p>
            ...
            <div class="widget-stat card">
              <div class="card-body p-4">
                <div class="media ai-icon d-flex">
                  ...
                  <div class="media-body" style="padding-left: 4px;">
                    <h3 class="mb-2 text-black" style="font-size:1.8rem;font-weight: 600;"><span class="counter ms-0"><?php echo number_format(@$parkingSummaryList->total_parking);?></span></h3>
                    <p class="mb-0"><h5 style="font-family: 'kanit';">ค่าจอด</h5></p>
            ...
            <div class="widget-stat card">
              <div class="card-body p-4">
                <div class="media ai-icon d-flex">
                  ...
                  <div class="media-body" style="padding-left: 4px;">
                    <h3 class="mb-2 text-black" style="font-size:1.8rem;font-weight: 600;"><span class="counter ms-0"><?php echo number_format(@$comGuideSummaryList->total_commisssion);?></span></h3>
                    <p class="mb-0"><h5 style="font-family: 'kanit';">คอมไกด์</h5></p>
            ...
            <div class="widget-stat card">
              <div class="card-body p-4">
                <div class="media ai-icon d-flex">
                  ...
                  <div class="media-body" style="padding-left: 4px;">
                    <h3 class="mb-2 text-black" style="font-size:1.8rem;font-weight: 600;"><span class="counter ms-0"><?php echo number_format(@$comCompanySummaryList->total_commisssion);?></span></h3>
                    <p class="mb-0"><h5 style="font-family: 'kanit';">คอมทัวร์</h5></p>
          ...
          <div class="col-xl-8 col-xxl-8 col-lg-12 col-md-12">
            <div class="card">
              <div class="card-header border-0 pb-0 d-sm-flex flex-wrap d-block">
                <div class="mb-3">
                  <h4 class="card-title mb-1 text-primary">สรุปยอดขายประจำวัน</h4>
                </div>
                <div class="card-action card-tabs mb-2">
                  <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active" data-bs-toggle="tab" href="#Monthly" role="tab">
                        <h4 class="mb-0" style="font-family: 'Kanit';">แยกตาม ประเภทเงิน</h4>
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" data-bs-toggle="tab" href="#Weekly" role="tab">
                        <h4 class="mb-0" style="font-family: 'Kanit';">แยกตาม แคชเชียร์</h4>
                      </a>
                    </li>
                  ...
                  <div class="row">
                    <div class="col-sm-4 mb-4">
                      <div class="border px-3 py-3 rounded-xl">
                        ...
                        <p class="fs-16 mb-0" style="color:#ff6d4d!important;font-weight: 600;">เงินสด</p>
                      </div>
                    </div>
                    <div class="col-sm-4 mb-4">
                      <div class="border px-3 py-3 rounded-xl">
                        <h2 class="fs-23 font-w600 counter"><?php echo number_format(@$incomeSummaryList->credit);?></h2>
                        <p class="fs-16 mb-0" style="color:#2bc155!important;font-weight: 600;">บัตรเครดิต</p>
                      </div>
                    </div>
                    <div class="col-sm-4 mb-4">
                      <div class="border px-3 py-3 rounded-xl">
                        <h2 class="fs-23 font-w600 counter"><?php echo number_format(@$incomeSummaryList->promptpay);?></h2>
                        <p class="fs-16 mb-0" style="font-weight: 600;">PromptPay</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="tab-pane fade" id="Weekly">
                  ...
                  <div class="row">
                    ...
                    foreach($incomeSummaryByCashierList as $row){
                      ...
                      $promptpay_percent = round((100/$row->grand_total)*$row->promptpay);
                      //console($row);
                    ?>
                    ...
                    <div class="col-xl-9 col-lg-10 col-xxl-8 col-sm-9 col-md-9" style="margin-top:1rem;">
                        <div class="d-flex align-items-center mb-3">
                          <p class="mb-0 fs-22 me-2 col-4 col-xxl-5 px-0" style="color:#ff6d4d!important;font-weight: 400;">เงินสด</p>
                        ...
                        <div class="d-flex align-items-center  mb-3">
                          <p class="mb-0 fs-22 me-2 col-4 col-xxl-5 px-0" style="color:#2bc155!important;font-weight: 600;">บัตรเครดิต</p>
                          <div class="progress mb-0" style="height:8px; width:100%;">
                        ...
                        <div class="d-flex align-items-center">
                          <p class="mb-0 fs-22 me-2 col-4 col-xxl-5 px-0" style="font-weight: 600;">PromptPay</p>
                          <div class="progress mb-0" style="height:8px; width:100%;">
          ...
          <div class="col-xl-4 col-xxl-4 col-lg-12 col-md-12">
            <div class="card">
              <div class="card-header border-0 pb-0 d-sm-flex d-block">
                <div class="mb-3">
                  <h4 class="card-title mb-1 text-primary">ค่าจอดรถ</h4>
                </div>
              </div>
              <div class="card-body revenue-chart px-3">
                  <div class="d-flex flex-wrap justify-content-end pe-3 pull-right revenue-chart-bar">
                    <div class="d-flex align-items-end me-4 mb-2">
                      <div>
                        <h3 class="font-w600 mb-0"><span class="counter"><?php echo number_format(@$parkingSummaryList->total_parking);?> บาท</h3>
                      </div>
                    </div>

                    <div class="d-flex align-items-end mb-2">
                      <div>
                        <h3 class="font-w600 mb-0">| <span class="counter"><?php echo number_format(@$parkingSummaryList->total_group);?> กลุ่ม </span></h3>
                      </div>
                    </div>
                  </div>
                <div id="chartBar"></div>
