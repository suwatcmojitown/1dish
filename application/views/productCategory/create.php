					...
					<div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header bg-info">
                                <h4 class="card-title text-white" > + เพิ่ม Product Category</h4>
                            </div>
                            <div class="card-body">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a href="<?php echo base_url('product-category/list');?>"><button type="button" class="btn btn-primary">กลับสู่หน้าหลัก</button></a>
    ...
    $("#submit_btn").click(function(){
                ...
                var status = document.getElementById("status").value;
                    data.append('status', status);
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: '<?php echo base_url('product-category/add')?>',
                                        data: data,
                                        processData: false,
                                        contentType: false,
