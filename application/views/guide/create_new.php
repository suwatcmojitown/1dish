<div class="content-body">
			...
			<div class="container-fluid">
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="<?php echo base_url('admin/list');?>">Guide</a></li>
					...
					<div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header bg-info">
                                <h4 class="card-title text-white" > + เพิ่ม Guide</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <form id="addForm">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control form-control-lg" name="id_card">
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="file" class="form-control form-control-lg" name="id_card_image" style="padding-top: 14px;">
                                                </div>
                                            </div>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a href="<?php echo base_url('guide/list');?>"><button type="button" class="btn btn-primary">Back to content list</button></a>
...
/*
                var group_admin_id = document.getElementById("group_admin_id").value;
                    ...
                    */
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: '<?php echo base_url('guide/add')?>',
                                        data: data,
                                        processData: false,
                                        contentType: false,
