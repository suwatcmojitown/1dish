			...
			<div class="container-fluid">
				<div class="form-head d-flex mb-3 align-items-start">
					<div class="me-auto d-none d-lg-block ">
						<h2 class="text-primary font-w600 mb-0"><i class="fas fa-user-alt"></i> Guide</h2>
						<ol class="breadcrumb">
                    ...
                    <a href="<?php echo base_url('guide/create');?>" id="add-order" class="btn btn-warning btn-rounded ms-3">Add +</a>
                    <!--
                    <div class="dropdown custom-dropdown ms-3">
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title"><span class="badge badge-lg badge-danger"> <i class="fa fa-exclamation" aria-hidden="true"></i> </span> ยืนยันลบไกด์ <span class="text-danger">#1</span> </h4>
...
function loadPage(page){
    ...
    $.ajax({
                type: 'POST',
                url: '<?php echo base_url('guide/loadContentList')?>',
...
function confirmDelete(id){
            ...
            $.ajax({
                        type: 'POST',
                        url: '<?php echo base_url('guide/delete')?>',
