                                ...
                                <div class="card-order-footer" style="margin-top: 4rem;bottom: 2rem;">
                                    ...
                                    <div class="btn_box">
                                        <div class="row no-gutter mx-0">
                                            ...
                                            if($detail->status==1){
                                            ?>
                                            <a href="<?php echo base_url('commission/company/print/').$detail->tour_grouping_id;?>" target="_blank" id="place-order-tab" class="btn btn-info btn-block col-6 m-0 rounded-0">ปริ๊น</a>
                                            <?php 
                                            }
                                            ?>
                                        </div>
