                            ...
                            <div class="cf nestable-lists card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <h4 class="card-title text-custom"> <i class="fas fa-pencil-alt"></i> เพิ่ม Bubble </h4>
...
<script>
    ...
    function deleteContent(id){
        ...
        $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url('bubble/deleteContentItem')?>',
                    data: 'id='+id+'',
                    success: function(result) { 
                        //$('#result').html(result);
                        $("#nestable").html(result);
    ...
    function editContent(id){
                    $.ajax({
                                        type: 'POST',
                                        url: '<?php echo base_url('bubble/edit')?>',
                                        data: 'id='+id,
                                        success: function(result) { 
                                            $("#_edit").html(result);
                                        } 
                ...
                var file_data = $('input[name="image"]')[0].files;
                    for (var i = 0; i < file_data.length; i++) {
                        data.append("image", file_data[i]);
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: '<?php echo base_url('bubble/add')?>',
                                        data: data,
                                        processData: false,
                                        contentType: false,
                                        success: function(result) { 
