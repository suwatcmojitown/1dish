			...
			<div class="container-fluid">
				...
				<div class="form-head d-flex mb-3 align-items-start">
					<div class="me-auto d-none d-lg-block ">
						<h2 class="text-custom font-w600 mb-0"><i class="fas fa-paper-plane"></i> Shelf : <?php echo @$detail->title_th;?></h2>
						<ol class="breadcrumb">
                                    ...
                                    <table class="table custom table-responsive-sm">
                                        ...
                                        <ul id="sortable" class="task-list">
                                            ...
                                            if($list){
                                                ...
                                                foreach($list as $row){
                                            ?>
                                            <li id="item-<?php echo $row->id.'|'.$row->product_id;?>" class="list-<?php echo @$row->sort;?>">
  ...
  $(document).ready(function () {
        ...
        $('.task-list').sortable(
            ...
            stop: function (event, ui) {
                ...
                //$('#txt').text(sort);
                $.ajax({
                    data: sort+ "&shelf_id=<?php echo $shelf_id;?>",
                    type: 'POST',
