                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header" style="background-color: #ab0600;">
                                <h4 class="card-title text-white" > <i class="lni lni-car"></i> จัดการ Catgory </h4>
                            </div>
                            ...
                            <div class="cf nestable-lists card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <h4 class="card-title text-custom"> <i class="fas fa-pencil-alt"></i> เพิ่ม Carbrand </h4>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a href="<?php echo base_url('carbrand');?>"><button type="button" class="btn btn-primary">กลับสู่หน้าหลัก</button></a>
...
<script>
    ...
    function deleteContent(id){
        ...
        $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url('carbrand/deleteContentItem')?>',
                    data: 'id='+id+'',
    ...
    function editContent(id){
                    $.ajax({
                                        type: 'POST',
                                        url: '<?php echo base_url('carbrand/edit')?>',
                                        data: 'id='+id,
                                        success: function(result) { 
                                            $("#_edit").html(result);
                                        } 
                ...
                var file_data = $('input[name="image"]')[0].files;
                    for (var i = 0; i < file_data.length; i++) {
                        data.append("image", file_data[i]);
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: '<?php echo base_url('carbrand/add')?>',
                                        data: data,
                                        processData: false,
                                        contentType: false,
                                        success: function(result) { 
