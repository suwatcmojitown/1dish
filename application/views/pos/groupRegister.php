...
<body class="custom">
				...
				<div class="main-bar clearfix ">
					<div class="container-fluid clearfix">
						...
						<div class="logo-header mostion logo-dark">
							<a href="front-dashboard.html"><img src="<?php echo base_url()?>app-assets/images/logo-text.png" alt=""></a>
						</div>
						<!-- Nav Toggle Button -->
        ...
        ***********************************-->
        <div class="content-body custom">
            <div class="container-fluid">
                <!-- row -->
                <div class="row">
                    <div class="offset-xl-2 col-xl-8 offset-xxl-2 col-xxl-8">
                        <div class="card">
                            <div class="card-header order-info">
                                <h3 class="card-title"><img src="<?php echo base_url()?>app-assets/images/custom/createGroup_icon.png" style="max-height: 28px;"> ลงทะเบียน</h3>
                            </div>
                            <div class="card-body">
								<div id="smartwizard" class="form-wizard custom order-create">
									<ul class="nav nav-wizard custom mb-5" id="nav_ul">
									...
									<div class="tab-content">
										<div id="group" class="tab-pane form-custom" role="tabpanel">
											<div class="mb-3 row">
	                                            <label class="col-sm-3 col-form-label custom text-info">ชื่อกรุ๊ป</label>
	                                            <div class="col-sm-9">
	                                                <input type="text" class="form-control form-control-lg" placeholder="ไม่ต้องใส่ก็ได้">
	                                            </div>
	                                        </div>
	                                        ...
	                                        <div class="mb-3 row">
	                                            <label class="col-sm-3 col-form-label custom text-info">% ส่วนลด</label>
										...
										<div id="percent" class="tab-pane" role="tabpanel">
											<div class="mb-3 row">
	                                            <label class="col-sm-3 col-form-label custom text-info">ชื่อไกด์</label>
	                                            <div class="col-sm-6">
	                                        ...
	                                        <div class="mb-3 row">
	                                            <label class="col-sm-3 col-form-label custom text-info">ชื่อทัวร์</label>
	                                            <div class="col-sm-6">
	                                                <input type="text" class="form-control form-control-lg" placeholder="">
	                                            </div>
	                                            <div class="col-sm-3">
	                                                <button type="button" class="btn btn-rounded btn-info"><span class="btn-icon-start text-info"><i class="fa fa-plus color-info"></i>
                                    				</span>เลือกทัวร์</button>
	                                            </div>
	                                        </div>

	                                        <div class="mb-3 row">
	                                            <label class="col-sm-3 col-form-label custom text-info">% ทัวร์</label>
	                                            <div class="col-sm-9 select-custom">
	                                                <select class="form-control " >
		                                                <option> --- กรุณาเลือก --- </option>
		                                                <option>10%</option>
										...
										<div id="info" class="tab-pane" role="tabpanel">
											<div class="mb-3 row">
	                                            <label class="col-sm-3 col-form-label custom text-info">สัญชาติ</label>
	                                            <div class="col-sm-9 select-custom">
	                                                <select class="form-control " >
		                                                <option> --- กรุณาเลือก --- </option>
		                                                <option>10%</option>
											...
											<div class="mb-3 row">
	                                            <label class="col-sm-3 col-form-label custom text-info">จำนวนสมาชิก ผู้ใหญ่</label>
	                                            <div class="col-sm-9">
	                                                <input type="text" class="form-control form-control-lg" placeholder="">
	                                            </div>
	                                        </div>
	                                        ...
	                                        <div class="mb-3 row">
	                                            <label class="col-sm-3 col-form-label custom text-info">จำนวนสมาชิก เด็ก</label>
	                                            <div class="col-sm-9">
	                                                <input type="text" class="form-control form-control-lg">
	                                            </div>
	                                        </div>
	                                        ...
	                                        <div class="mb-3 row">
	                                            <label class="col-sm-3 col-form-label custom text-info">ค่าจอดรถที่จ่าย</label>
	                                            <div class="col-sm-9">
	                                                <input type="text" class="form-control form-control-lg">
	                                            </div>
	                                        </div>
   ...
   <!-- Required vendors -->
    ...
    <script src="<?php echo base_url()?>app-assets/vendor/jquery-steps/build/jquery.steps.min.js"></script>
