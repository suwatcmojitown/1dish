			...
			<div class="container-fluid">
				...
				<div class="form-head d-flex mb-3 align-items-start">
					<div class="me-auto d-none d-lg-block ">
						<h2 class="text-custom font-w600 mb-0"><i class="fas fa-star"></i> Top Banner</h2>
						<ol class="breadcrumb">
                                            ...
                                            <li id="item-<?php echo $row->id;?>" class="list-<?php echo @$row->sort;?>">
                                                <div class="task-title row">
                                                        ...
                                                        <div class="col-lg-8">
                                                            ...
                                                            <span class="text-custom">External Link : </span><span class="text-muted"><?php echo @$row->external_link;?></span>
                                                            </normal>
                                                        </div>
                                                </div>
                                                <hr>
                                            ...
                                            <div class="modal fade text-start" id="result_modal_fail" tabindex="-1" aria-labelledby="myModalLabel17" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a href="<?php echo base_url('highlight');?>"><button type="button" class="btn btn-danger">กลับสู่หน้าหลัก</button></a>
                                                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">ตกลง</button>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        $('.task-list').sortable(
            ...
            stop: function (event, ui) {
                ...
                $.ajax({
                    data: sort,
                    type: 'POST',
                    url: '<?php echo base_url('highlight/updateOrder')?>',
