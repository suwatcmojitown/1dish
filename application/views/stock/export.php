					...
					<div class="col-4">
                        <div class="card">
                            <div class="card-header bg-danger">
                                <h4 class="card-title text-white" > <i class="fas fa-plus-circle"></i> นำสินค้าออก</h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form class="row" id="addForm">
                                        <span id="result"></span>
                                        <input type="hidden" class="form-control form-control-lg" name="requisition_out_id" value="<?php echo $uuid;?>">
                                        ...
                                        <div class="mb-3 mt-3" style="text-align: center;">
                                            <button id="submit_btn" type="button" class="btn btn-danger light" data-bs-toggle="modal" data-bs-target=".bd-example-modal-md">+ เพิ่มในรายการสินค้านำออก</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
...
<script>
    ...
    $("#submit_btn").click(function(){
                ...
                //alert(temp.value);
                const myArray = temp.value.split("|");
                let stock_quantity = myArray[1];
                ...
                if(stock_quantity<quantity)
                {
                        ...
                        data.append('barcode', barcode);
                                            ...
                                            $.ajax({
                                                type: 'POST',
                                                url: '<?php echo base_url('stock/export/addProduct')?>',
                                                data: data,
                                                processData: false,
                                                contentType: false,
...
<script>
    ...
    function productChange(){
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url('stock/loadExportProductStockList')?>',
