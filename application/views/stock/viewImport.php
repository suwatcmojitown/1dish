<div class="content-body">
					...
					<div class="col-12">
                        <div class="card">
                            <div class="card-header bg-info">
                                <h4 class="card-title text-white" > <i class="fas fa-list"></i> รายการสินค้านำเข้า #<?php echo @$detail->document_no;?></h4>
                            </div>
                                            ...
                                            <div class="modal fade text-start" id="result_modal" tabindex="-1" aria-labelledby="myModalLabel17" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a href="<?php echo base_url('stock/report/import');?>"><button type="button" class="btn btn-primary">กลับสู่หน้าหลัก</button></a>
        ...
        <script>
            function updateNote(){
                    ...
                    $.ajax({
                                type: 'POST',
                                url: '<?php echo base_url('stock/import/updateNote')?>',
                                data: data,
                                processData: false,
                                contentType: false,
