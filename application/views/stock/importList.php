            ...
            <div class="container-fluid">
                <div class="form-head d-flex mb-3 align-items-start">
                    <div class="me-auto d-none d-lg-block ">
                        <h2 class="text-primary font-w600 mb-0"><i class="fa-solid fa-user-secret"></i> Import</h2>
                        <ol class="breadcrumb">
                    ...
                    <div class="mb-3" style="margin-right: 3px;">
                            <input id="keysearch" class="form-control form-control-lg" type="text" placeholder="ค้นหาด้วยเลขเอกสาร" >
                    </div>
...
function loadPage(page){
    ...
    $.ajax({
                type: 'POST',
                url: '<?php echo base_url('stock/loadImportList')?>',
...
$("#filterBtn").click(function(){
    ...
    $.ajax({
                type: 'POST',
                url: '<?php echo base_url('stock/loadImportList')?>',
                data: 'keysearch='+keysearch+'&page=1',
                success: function(result) { 
                    //$('#result').html(result);
                    $("#_list").html(result);
                } 
