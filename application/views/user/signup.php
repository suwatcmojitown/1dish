                ...
                <div class="auth-wrapper auth-cover">
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="<?php echo base_url();?>app-assets/images/pages/register-v2.svg" alt="Register V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Register-->
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <form class="auth-register-form mt-2" id="registerForm">
                                    <div class="mb-1">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control" id="register-email" type="text" name="email" placeholder="" aria-describedby="register-email" tabindex="2" />
                                    </div>
                                    <div class="mb-1">
                                    ...
                                    -->
                                    <button class="btn btn-primary w-100" type="button" tabindex="5" id="submit_btn">Sign up</button>
                                </form>
