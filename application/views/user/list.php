            ...
            <div class="content-header row">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo base_url('user/list')?>">List</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="content-header-right text-md-end col-md-3 col-12 d-md-block d-none">
                    <div class="mb-1 breadcrumb-right">
                        <div >
                            <a href="<?php echo base_url('user/signup');?>"><button class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle" type="button"> + Create New User</button></a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row">
                                        <div class="col-6">
                                            <div class="input-group">
                                                <input type="text" class="form-control" placeholder="Title" aria-describedby="button-addon2" name="keysearch" id="keysearch">
                                                <button class="btn btn-outline-primary waves-effect" id="searchBtn" type="button">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-search"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg> Search
                                                </button>
                                            </div>
                                        </div>
                                        <!--
                                        <div class="col-4">
                                            <a ><h4 class="text-primary" style="padding-top: 8px;"><strong>+ Create New Content</strong></h4></a>
                                        </div>
                                        -->
                                    </div>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td>
                                                ...
                                                <a onclick="getUserDetail(<?php echo $row->user_id;?>)" data-toggle="modal"><button type="button" class="btn btn-icon rounded-circle btn-outline-primary waves-effect" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="แก้ไข">
...
<!-- Position -->
    <button id="userModalBtn" type="button" class="btn btn-outline-primary hidden" data-bs-toggle="modal" data-bs-target="#userDetail">
    User
    </button>
                                            <!-- Modal -->
                                            <div class="modal modal-primary fade text-start" id="userDetail" tabindex="-1" aria-labelledby="myModalLabel20" aria-hidden="true" >
                                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body" id="_DetailUser">
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" id="userBtn" class="btn btn-primary" data-bs-dismiss="modal">Save</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script>
    ...
    $("#userBtn").click(function(){
            ...
            $.ajax({
                                    type: 'POST',
                                    url: '<?php echo base_url('user/userUpdate')?>',
                                    data: data,
                                    processData: false,
                                    contentType: false,
                                    success: function(result) { 
