                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header bg-custom">
                                <h4 class="card-title text-white" > <i class="fas fa-pencil-alt"></i> แก้ไข Content : <?php echo @$detail->title_th;?></h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form class="row" id="addForm">
                                        ...
                                        <div class="mb-3 col-12">
                                                ...
                                                <input type="text" class="form-control form-control-lg" name="youtube_link" value="<?php echo @$detail->youtube_link;?>">
                                        </div>
