                            ...
                            <div class="cf nestable-lists card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <h4 class="card-title text-custom"> <i class="fas fa-pencil-alt"></i> เพิ่ม Category </h4>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a href="<?php echo base_url('category');?>"><button type="button" class="btn btn-primary">กลับสู่หน้าหลัก</button></a>
...
<script>
    ...
    function deleteContent(id){
        ...
        $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url('category/deleteContentItem')?>',
                    data: 'id='+id+'',
